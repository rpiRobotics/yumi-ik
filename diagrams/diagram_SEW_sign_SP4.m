...
diagrams.plane(ex*dot(ex, rot(ex, 0.7*pi)*rot(ez, pi/4)*ex), ex, ez, 1);
diagrams.line(rot(-ey, pi/4)*ex, rot(ey, pi/4)*ex, LineStyle=":");
diagrams.line(ex*dot(ex, rot(ex, 0.7*pi)*rot(ez, pi/4)*ex), rot(ex, 0.7*pi)*rot(ez, pi/4)*ex, LineStyle=":")
